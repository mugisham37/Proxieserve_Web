...
export function HeroSection() {
  ...
  return (
    <section
      ref={heroRef}
      className="max-w-[1280px] mx-auto px-8 pt-20 pb-16 grid grid-cols-2 gap-16 items-center md:grid-cols-1 md:px-4 md:pt-12 md:pb-10 md:gap-8"
    >
      {/* Content */}
      <div className="hero-content">
        <SectionLabel>Autonomous E-Commerce Revenue Engine</SectionLabel>
        <h1 className="text-[clamp(32px,5vw,52px)] font-bold tracking-[-0.03em] leading-[1.15] mb-5 text-text">
          Upload a product.
          <br />
          SolAI runs <em>everything</em> else.
        </h1>
        <p className="text-[clamp(16px,1.8vw,18px)] text-text-muted leading-[1.7] mb-7 max-w-[520px]">
        ...
        <div className="flex gap-3 mb-7 flex-wrap">
          ...
          <Link
            href="#demo"
            className="inline-flex items-center gap-1.5 px-7 py-3.5 text-[15px] font-medium bg-transparent text-text border border-border rounded-[10px] no-underline hover:no-underline hover:bg-surface-2 hover:border-text-subtle transition-all duration-150"
          >
            Watch demo
          </Link>
        </div>

        <div className="text-[13px] text-text-subtle flex flex-col gap-1">
      ...
      <div className="hero-visual md:order-first">
        <div
